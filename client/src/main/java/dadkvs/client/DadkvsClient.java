...
import dadkvs.util.OrderedDelayer;
...
public class DadkvsClient {
    ...
    public DadkvsClient() {
        ...
        delayer = new OrderedDelayer(n_servers);
    }
    ...
    private void doTransactions() throws Exception {
        ...
        while (counter < loop_size) {
            ...
            if (doCommit(read_key1, kv_entry1.getVersion(), read_key2, kv_entry2.getVersion(), write_key,
                    write_value)) {
                committed++;
            }
            Thread.sleep(rnd.nextInt(sleep_range) * 1000);
        ...
        while (cursor < length) {
            ...
            switch (option_name) {
                ...
                case "-i":
                    ...
                    break;
                case "--delay":
                    if (option_parts.length < 3) {
                        System.err.println("usage: --delay server_id delay_value");
                    } else {
                        try {
                            ...
                            System.err.println("Invalid number format for server_id or delay_value");
                        }
                    }
                    break;
                default:
