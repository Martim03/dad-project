...
public class DadkvsPaxosServiceImpl extends DadkvsPaxosServiceGrpc.DadkvsPaxosServiceImplBase {
    ...
    public void phaseone(DadkvsPaxos.PhaseOneRequest request,
        ...
        if (request.getPhase1Timestamp() < requestHandler.getRequestByOrder(request.getPhase1Index()).getReadTS()) {
            // reject the request
    ...
    public void phasetwo(DadkvsPaxos.PhaseTwoRequest request,
        ...
        if (request.getPhase2Timestamp() != requestHandler.getRequestByOrder(request.getPhase2Index()).getReadTS()) {
            // reject the request
        ...
        // Print debug message
        System.out.println(
                "Accepting phase two request: idx=" + request.getPhase2Index() + " ts=" + request.getPhase2Timestamp());
        ...
        // Print debug message
        System.out.println(
                "Phase two request accepted: idx=" + request.getPhase2Index() + " ts=" + request.getPhase2Timestamp());
